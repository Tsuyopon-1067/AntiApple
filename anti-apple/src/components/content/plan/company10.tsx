    ...
    return (
        <div>
          <GenerateArticle
            ...
            abstract="J:COMはau回線のみの提供をしている格安SIMです。割引やデータ増量特典を利用すれば格安SIM最安級でとてもコスパがよいです。逆に割引や特典が適用されない場合は若干料金が割高です。"
            gbtable={["1GB", "5GB", "20GB", "30GB"]}
            valuetable={[1078, 1628, 2178, 2728]}
            valueremarktable={[
            ...
            speed="J:COMの通信速度は比較的速いです。昼間に極端に落ち込むということもそこまでなく、安定した速度で利用することができます。"
            recommended="訪問サポートが利用できるため、オンライン専用プランが不安という方におすすめです。ドコモ、ソフトバンク回線は使えないため、ドコモ、ソフトバンク回線を使いたい人は他の会社がおすすめです。J:COMのインターネット、電気など他のサービスを利用している人は追加でデータを付与されるため要チェックです。"
