    ...
    return (
        <div>
          <GenerateArticle
            ...
            abstract="IIJmioはIIJ社が運営する格安SIMで、5種類のデータ容量と、ドコモ、auの2種類の回線から選ぶことができます。データSIMを含めた全プランでeSIMを利用することができ、iPhoneなどeSIM対応機でサブ回線を持ちたい方にもおすすめです。"
            ...
            speed="IIJmioの通信速度は格安SIMの中では遅くはないです。IIJmioは格安SIMという言葉が登場し始めた初期からサービスを提供しており、回線の安定性は年々増しています。速度自体は特段遅くも速くもないですが、昼間の速度の落ち込みも少なく快適に利用することができます。"
            recommended="格安SIMの老舗であるため、安定感があります。そのため情報が多く格安SIM初心者にもおすすめです。また、頻繁に端末購入割引を行っており、端末とセットで回線契約したい方にもおすすめです。また、全体的に利用料金が安いため、費用を抑えて利用したい方にもおすすめです。"
