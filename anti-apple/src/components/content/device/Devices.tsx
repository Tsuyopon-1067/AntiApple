...
export const motog52j = new DeviceParameter(
  ...
  "motorola motoシリーズのミドルレンジスマホです。motorolaのスマホでは初めておサイフケータイ、IP68等級の防水防塵を搭載したため、モバイルSuicaやQUICPayなどの電子マネーを利用する方や今まで防水防塵のあったスマホを利用していた方にもおすすめです。また画面サイズが6.8インチとかなり大きくイヤホンジャックも残っているため電子書籍や漫画、動画などのコンテンツを視聴する機会が多い方にもおすすめです。一部の格安SIM事業者では安く購入できる場合があるので、おサイフケータイや防水防塵のついたスマホをできるだけ安く購入したい方は要チェックです。",
