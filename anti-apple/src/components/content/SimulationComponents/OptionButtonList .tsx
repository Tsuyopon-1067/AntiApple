...
export const OptionButtonList = (props) => {
    ...
    return(
        <React.Fragment>
            <ToggleButton getState={setIsChecked0}>無制限通話</ToggleButton>
            <ToggleButton getState={setIsChecked1}>通話（時間制限あり）</ToggleButton>
            <ToggleButton getState={setIsChecked2}>なにか</ToggleButton>
        </React.Fragment>
    );
}